...
export async function planSceneImage(scene: SceneInstruction): Promise<ImagePlan> {
  const prompt = [
    ...
    "- FACE (when visible): round plain white balloon head, two small black dot eyes,",
    "  mouth is ONE short straight horizontal black line only — fully neutral, deadpan,",
    "  no smile, frown, smirk, or worried mouth shapes.",
    "  NO blushing, NO pink or red on cheeks or face, NO rosy skin — head stays flat white",
    "  except the black eyes and black mouth. No other facial marks or features ever.",
